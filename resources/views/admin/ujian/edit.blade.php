...
<head>
    ...
    <title>Edit Ujian | ONMAI Admin</title>
...
<body class="bg-gray-100 font-body text-gray-800 flex h-screen overflow-hidden relative">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden w-full">
        <header class="h-20 bg-white shadow-sm flex items-center justify-between px-4 md:px-8 border-b-4 border-brand z-10 shrink-0">
            ...
            <h2 class="text-xl font-bold font-heading text-gray-800">Edit Ujian</h2>
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-4 md:p-8">
            ...
            <div class="max-w-3xl mx-auto animate-[fadeIn_0.5s_ease-out]">
                ...
                <div class="bg-white rounded-2xl shadow-lg border-t-4 border-blue-600 overflow-hidden">
                    <div class="p-8">
                        <div class="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold font-heading text-gray-800">Edit Data Ujian</h2>
                                <p class="text-sm text-gray-500">Perbarui informasi ujian ini.</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="nama_ujian" value="{{ old('nama_ujian', $ujian->nama_ujian) }}" required
                                            class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition shadow-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="mapel" value="{{ old('mapel', $ujian->mapel) }}" required
                                            class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition shadow-sm"
                                ...
                                <div>
                                    ...
                                    <select name="kelas" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition shadow-sm">
                                        <option value="10" {{ $ujian->kelas == '10' ? 'selected' : '' }}>Kelas 10</option>
                                        <option value="11" {{ $ujian->kelas == '11' ? 'selected' : '' }}>Kelas 11</option>
                                        <option value="12" {{ $ujian->kelas == '12' ? 'selected' : '' }}>Kelas 12</option>
                                        <option value="Umum" {{ $ujian->kelas == 'Umum' ? 'selected' : '' }}>Umum</option>
                                    </select>
                                </div>
                                ...
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Waktu Mulai <span class="text-red-500">*</span></label>
                                            <input type="datetime-local" name="waktu_mulai" 
                                                value="{{ old('waktu_mulai', \Carbon\Carbon::parse($ujian->waktu_mulai)->format('Y-m-d\TH:i')) }}" 
                                                required
                                                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 outline-none transition shadow-sm bg-white">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Waktu Selesai <span class="text-red-500">*</span></label>
